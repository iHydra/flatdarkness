...
var scrollBottom = $('<a href=\"#\"/ title=\"Scroll to Top\"/ class=\"scrollToTop\"/></a>'); // Scroll To Bottom
$('body').append('<div class="scrollTo">' + scrollTop + scrollBottom + '</div>');
...
$('.scrollToBottom').click(function() {
    $('html, body').animate({ scrollBottom: 900 }, 800);
    return false;
});
...
if (window.location.href == "https://hackforums.net/misc.php?action=buddypopup") { // Buddy List Online Status Fix
    ...
    $('img[src$="/buddy_away.gif"]').attr('src', 'https://i.imgur.com/x7dAaGE.png').attr('style', ''); // Away Status
    $('img[src$="/buddy_online.gif"]').attr('src', 'https://i.imgur.com/lpKaTIB.png').attr('style', ''); // Online Status
    $('img[src$="/buddy_offline.gif"]').attr('src', 'https://i.imgur.com/EKt4fXk.png').attr('style', ''); // Offline Status
} else if (window.location.href == "https://hackforums.net/usercp.php?action=editlists") {
    $('img[src$="/buddy_away.gif"]').attr('src', 'https://i.imgur.com/x7dAaGE.png').attr('style', 'vertical-align: top;'); // Away Status
    $('img[src$="/buddy_online.gif"]').attr('src', 'https://i.imgur.com/lpKaTIB.png').attr('style', 'vertical-align: top;'); // Online Status
    $('img[src$="/buddy_offline.gif"]').attr('src', 'https://i.imgur.com/EKt4fXk.png').attr('style', 'vertical-align: top;'); // Offline Status
} else {
    $('img[src$="/buddy_away.gif"]').attr('src', 'https://i.imgur.com/x7dAaGE.png').attr('style', 'position: absolute; padding-top: 4px;'); // Away Status
    $('img[src$="/buddy_online.gif"]').attr('src', 'https://i.imgur.com/lpKaTIB.png').attr('style', 'position: absolute; padding-top: 4px;'); // Online Status
    $('img[src$="/buddy_offline.gif"]').attr('src', 'https://i.imgur.com/EKt4fXk.png').attr('style', 'position: absolute; padding-top: 4px;'); // Offline Status
}
